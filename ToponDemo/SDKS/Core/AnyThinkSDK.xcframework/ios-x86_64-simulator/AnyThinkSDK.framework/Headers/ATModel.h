...
typedef NS_ENUM(NSInteger, ATGuideClickOverlayType) {
    ...
    ATGuideClickOverlayTypeGestureGuidance    = 1,
    ATGuideClickOverlayTypeDragPuzzle         = 2,
    ATGuideClickOverlayTypeQAPopup            = 3,
    ATGuideClickOverlayTypeNoviceGuide        = 4,
    ATGuideClickOverlayTypeConfirmJump        = 5,
    ATGuideClickOverlayTypeFingerClickGuide   = 6,
    ATGuideClickOverlayTypeFullScreenSwipe    = 7
};
