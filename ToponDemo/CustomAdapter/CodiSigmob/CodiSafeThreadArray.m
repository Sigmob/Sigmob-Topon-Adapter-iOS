//
//  CodiSafeThreadArray.m
//  ToponDemo
//
//  Created by Codi on 2023/11/28.
//

#import "CodiSafeThreadArray.h"
#import <pthread.h>
...
@implementation CodiSafeThreadArray {
...
- (BOOL)isEqualToArray:(NSArray *)otherArray {
    ...
    if ([otherArray isKindOfClass:CodiSafeThreadArray.class]) {
        CodiSafeThreadArray *other = (id)otherArray;
        BOOL isEqual;
...
- (BOOL)isEqual:(id)object {
    ...
    if ([object isKindOfClass:CodiSafeThreadArray.class]) {
        CodiSafeThreadArray *other = object;
        BOOL isEqual;
        pthread_mutex_lock(&_mutex_lock);
        pthread_mutex_lock(&(other->_mutex_lock));
