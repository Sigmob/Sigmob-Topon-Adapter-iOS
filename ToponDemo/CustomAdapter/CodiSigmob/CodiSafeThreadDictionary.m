...
@implementation CodiSafeThreadDictionary {
...
- (BOOL)isEqualToDictionary:(NSDictionary *)otherDictionary {
    ...
    if ([otherDictionary isKindOfClass:CodiSafeThreadDictionary.class]) {
        CodiSafeThreadDictionary *other = (id)otherDictionary;
        BOOL isEqual;
...
- (BOOL)isEqual:(id)object {
    ...
    if ([object isKindOfClass:CodiSafeThreadDictionary.class]) {
        CodiSafeThreadDictionary *other = object;
        BOOL isEqual;
        pthread_mutex_lock(&_mutex_lock);
        pthread_mutex_lock(&(other->_mutex_lock));
        isEqual = [_dic isEqual:other->_dic];
